    ...
    <div>
        <b-navbar toggleable="lg" type="dark" variant="info">
            ...
            <b-navbar-nav>
                ...
                <b-nav-item href="/link2">Link2</b-nav-item>
                <b-nav-item href="/link3">Link3</b-nav-item>
            </b-navbar-nav>
